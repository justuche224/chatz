...
export const sendVerificationEmail = async (email, token) => {
  ...
  const mailOptions = {
    ...
    to: email,
    subject: "Verify your Friendz account",
    ...
    html: `
          ...
          <head>
              ...
              <title>Verify Your Friendz Account</title>
              <style>
                  body {
          ...
          <body>
              <div class="container">
                  <h1>Hello ${email},</h1>
                  <p>You've registered an account on Friendz. Before you can start using your account, we need to verify that this email address belongs to you.</p>
                  ...
                  <h3>Kind Regards,<br><a href="${process.env.CLIENT_URL}" style="color: #007bff; text-decoration: none;">Friendz</a></h3>
              </div>
          </body>
          </html>
        `,
